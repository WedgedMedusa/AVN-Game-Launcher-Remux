...
class DateTimeUtilsKtTest {
    ...
    fun `averagePlayTime correct result`() {
        ...
        val result = calculateAveragePlayTime(firstPlayedTime, System.currentTimeMillis(), totalPlayTime)
    ...
    fun `averagePlayTime firstPlayedTime less then 24h`() {
        ...
        val result = calculateAveragePlayTime(firstPlayed, System.currentTimeMillis(), totalPlayTime)
        assertTrue(result < 1)
    }
